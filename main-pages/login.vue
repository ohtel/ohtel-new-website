...
<script>
import image1 from "../assets/images/carousel/caurosel1.svg";
import image2 from "../assets/images/carousel/caurosel2.svg";
import image3 from "../assets/images/carousel/caurosel1.svg";
import image4 from "../assets/images/carousel/caurosel2.svg";
...
export default {
  ...
  methods: {
    login() {
      this.state = "otp_section"; // Switch to forgot password view
    },
    backToLogin() {
